...
library(ggplot2)
library(reshape2)
setwd("/Users/wangjun/Desktop/figure/TCR/")

data<-read.table(file="./FD1_LUAD_MIA1_top_10.csv",header = T,sep=",")
data<-melt(data)
colnames(data)<-c("Sequence","Tissue","Proportion")
p1<-ggplot(data, aes(
  x = factor(Sequence,levels = unique(Sequence)),            
  y = ifelse(Tissue == "LUAD", Proportion, -Proportion),  
  fill = Tissue)) +
...
library(Seurat)
setwd("/Users/wangjun/Desktop/final/figure/")
...
T_total<-readRDS(file="/Users/wangjun/Desktop/final/figure/T_total_update.rds")


T_total_test<-readRDS(file="/Users/wangjun/Desktop/final/figure/T_total_12_10.rds")
...
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/GZMB/6.png",dpi = 1000,width = 2.12,height = 3.44)
...
ggsave(p2,file="/Users/wangjun/Desktop/final/figure/figure2_2.png",dpi = 1000,width = 3.84,height = 5.87)
...
write.table(data_matrix,file="/Users/wangjun/Desktop/final/figure/T细胞marker表达量.csv",col.names = T,row.names = T,sep = ",")
...
p<-ggplot(data=CD8_C3_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/CD8_C3/total.png",dpi = 1000,width = 2.23,height = 3.44)
...
p<-ggplot(data=gdT_C1_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/gdT_C1/total.png",dpi = 1000,width = 2.12,height = 3.44)
...
p<-ggplot(data=gdT_C2_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/gdT_C2/FD14_LUAD_MIA.png",dpi = 1000,width = 2.12,height = 3.44)
...
p<-ggplot(data=CD4_C2_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/CD4_C2/FD14_LUAD_MIA.png",dpi = 1000,width = 2.23,height = 3.44)
...
NK_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/NK_cells_update.rds")
...
p<-ggplot(data=NK_plus_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/NK_plus/FD14_LUAD_MIA.png",dpi = 1000,width = 2.12,height = 3.44)
...
#肿瘤细胞通路富集结果
MIA_kegg<-read.table(file="/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG/MIA_Kegg.csv",sep = ",",header  = T,row.names = 1)
...
MIA_GO<-read.table(file="/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG/MIA_Go.csv",sep = ",",header  = T,row.names = 1)
...
LUAD_Kegg<-read.table(file="/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG/LUAD_Kegg.csv",sep = ",",header  = T,row.names = 1)
...
LUAD_GO<-read.table(file="/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG/LUAD_Go2.csv",sep = ",",header  = T,row.names = 1,quote ="")
...
p<-ggplot(data=B_cells_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/B_cells/total.png",dpi = 1000,width = 2.12,height = 3.44)
...
p<-ggplot(data=NK_cells_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/NK_cells/FD14.png",dpi = 1000,width = 2.12,height = 3.44)
...
ggsave(p2,file="/Users/wangjun/Desktop/final/figure/NK_cells.png",dpi = 1000,width = 3,height = 4.54)
...
ggsave(p2,file="/Users/wangjun/Desktop/final/figure/B_cells.png",dpi = 1000,width = 3,height = 4.54)
...
p<-ggplot(data=TCR_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/TCR/最高丰度/FD14.png",dpi = 1000,width = 1.87,height = 3.41)
...
p<-ggplot(data=TCR_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/TCR/肿瘤异质性相关/8_updata.png",dpi = 1000,width = 2.12,height = 3.41)
...
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T1_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T2_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T3_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T4_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T5_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T6_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T7_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T8_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T9_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T10_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T11_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T12_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T13_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T14_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T15_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T16_DEG_gene.csv")
...
scRNA.markers <- FindAllMarkers(object = T1, only.pos = TRUE, 
                                min.pct = 0.25, thresh.use = 0.25)
marker_gene <- scRNA.markers %>% filter(p_val_adj <= 0.01 & avg_log2FC>=1) %>% group_by(cluster) %>% top_n(n = 1000, wt = p_val_adj)
write.csv(marker_gene,"/Users/wangjun/Desktop/final/figure/病理分期差异基因/DEG_new/T17_DEG_gene.csv")
...
#
macrophage<-readRDS(file="/Users/wangjun/Desktop/final/figure/macrophages_update.rds")
...
library(Seurat)
library(dplyr)
B_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/B_cells_11_15.rds")
...
#计算T细胞的差异基因
T_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/T_total_12_10.rds")
...
#计算肥大细胞差异
B_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/Mast_cells.rds")
...
#计算成纤维细胞差异
B_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/Fibroblast.rds")
...
#计算内皮细胞差异
B_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/Endothelial.rds")
...
#计算NK细胞差异
B_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/NK_cells_update.rds")
...
#计算Plasma细胞差异
B_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/Plasma_cells.rds")
...
#计算AT_cluster细胞差异
B_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/AT_cluster.rds")
...
#计算macrophages细胞差异
macrophages_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/macrophages_update.rds")
...
library(Seurat)
#导入肿瘤细胞数据
data<-readRDS(file="/Users/wangjun/Desktop/final/figure/tumor_infercnv.rds")
...
#髓系细胞
library(Seurat)
Myeloid_cells<-readRDS(file="/Users/wangjun/Desktop/final/figure/macrophages_update.rds")
table(Idents(Myeloid_cells))
...
p<-ggplot(data=CD8_C5_new)+
  ...
  scale_discrete_manual(values=c("#4DBBD5FF","#E64B35FF"),aesthetics = 'colour')+NoLegend()
p
ggsave(p,file="/Users/wangjun/Desktop/final/figure/CD8_C5/FD14_LUAD_MIA.png",dpi = 1000,width = 2.23,height = 3.44)
...
library(Seurat)
#读取大类文件
pbmc<-readRDS(file="/Users/wangjun/Desktop/final/figure/pbmc_merge_new.rds")
table(Idents(pbmc))
...
#读取T细胞数据
library(Seurat)
Tumor<-readRDS(file="/Users/wangjun/Desktop/final/figure/tumor_infercnv.rds")
...
#重新检查合并情况
data<-readRDS("/Users/wangjun/Desktop/final/figure/T_total_update.rds")
...
library(reshape2)
library(ggplot2)
data<-read.table(file="/Users/wangjun/Desktop/final/figure/Fig_2D_细胞比例计算.csv",header=T,row.names = 1,sep = ",")
...
ggsave(P1_D,file="/Users/wangjun/Desktop/final/figure/Figure1_D.pdf",height = 4.23,width = 8.43)
...
ggsave(T_dotplot,file="/Users/wangjun/Desktop/final/figure/Figure4_B.pdf",height = 3.95,width = 14)
...
table(Idents(T_total))
cairo_pdf(filename="/Users/wangjun/Desktop/final/figure/Figure4_B.pdf",height = 3.95,width = 14)
...
ggsave(file="/Users/wangjun/Desktop/final/figure/Figure4_A.png",p5,height = 4,24,width = 6.98)
...
data<-read.table(file="/Users/wangjun/Desktop/final/figure/TCR_tumor.csv",header = T,sep = ",")
...
ggsave(p2,file="/Users/wangjun/Desktop/final/figure/Figure5_A.pdf",width = 2.12,height = 3.44)
...
ggsave(p2,file="/Users/wangjun/Desktop/final/figure/Figure5_E.pdf",width = 2.12,height = 3.44)
...
ggsave(p2,file="/Users/wangjun/Desktop/final/figure/Figure5_F.pdf",width = 2.12,height = 3.44)
...
ggsave(p2,file="/Users/wangjun/Desktop/final/figure/Figure5_J.pdf",width = 2.12,height = 3.44)